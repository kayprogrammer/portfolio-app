...
class SuscriberForm(ModelForm):
    email = forms.CharField(max_length=100, label=False, widget=forms.EmailInput(attrs={'placeholder':'Enter your email address', 'type':'email'}))
    class Meta:
        model = Suscriber
        fields = '__all__'
...
class DetailForm(ModelForm):
    ...
    email = forms.CharField(max_length=100, label=False, widget=forms.EmailInput(attrs={'placeholder':'Email Address...', 'class':'form2', 'type':'email'}))
